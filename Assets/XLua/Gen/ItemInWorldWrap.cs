...
namespace XLua.CSObjectWrap
{
    ...
    public class ItemInWorldWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ItemInWorld);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ItemInWorld constructor!");
        ...
        static int _g_get_itemType(RealStatePtr L)
        {
		    try {
                ...
                ItemInWorld gen_to_be_invoked = (ItemInWorld)translator.FastGetCSObj(L, 1);
                translator.PushItemType(L, gen_to_be_invoked.itemType);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_itemType(RealStatePtr L)
        {
		    try {
                ...
                ItemInWorld gen_to_be_invoked = (ItemInWorld)translator.FastGetCSObj(L, 1);
                ItemType gen_value;translator.Get(L, 2, out gen_value);
				gen_to_be_invoked.itemType = gen_value;
