...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineTransformWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 28, 19, 13);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetComponentButton", _m_GetComponentButton);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetComponentCollisionCb", _m_GetComponentCollisionCb);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetComponentImage", _m_GetComponentImage);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetComponentItemInWorld", _m_GetComponentItemInWorld);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetTextComponentInChildren", _m_GetTextComponentInChildren);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetTextComponent", _m_GetTextComponent);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetDragableComponentInChildren", _m_GetDragableComponentInChildren);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetComponentButton(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetComponentButton(  );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetComponentCollisionCb(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetComponentCollisionCb(  );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetComponentImage(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetComponentImage(  );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetComponentItemInWorld(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetComponentItemInWorld(  );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetTextComponentInChildren(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetTextComponentInChildren(  );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetTextComponent(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetTextComponent(  );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetDragableComponentInChildren(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetDragableComponentInChildren(  );
                        translator.Push(L, gen_ret);
