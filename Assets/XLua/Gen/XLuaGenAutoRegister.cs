...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(CollisionCallback), CollisionCallbackWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Dragable), DragableWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(ExtraMethod), ExtraMethodWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(ItemType), ItemTypeWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(ItemInWorld), ItemInWorldWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(ResourcesManager), ResourcesManagerWrap.__Register);
